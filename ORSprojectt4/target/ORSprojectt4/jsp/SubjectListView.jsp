...
<!DOCTYPE html>
<%@page import="in.com.rays.ORSprojectt4.model.SubjectModel"%>
<%@page import="in.com.rays.ORSprojectt4.model.CourseModel"%>
<%@page import="java.beans.beancontext.BeanContext"%>
<%@page import="in.com.rays.ORSprojectt4.utility.HTMLUtility"%>
<%@page import="in.com.rays.ORSprojectt4.bean.CourseBean"%>
<%@page import="in.com.rays.ORSprojectt4.servlet.SubjectListCtl"%>
<%@page import="in.com.rays.ORSprojectt4.bean.SubjectBean"%>
...
<body>
	<jsp:useBean id="bean"
		class="in.com.rays.ORSprojectt4.bean.SubjectBean" scope="request"></jsp:useBean>
	<center>
			...
			<table width="100%" align="center">
				<tr>
					<td align="center"><label>Subject Name :</label> <input
						type="text" value placeholder="Enter subject name"
						value="<%=ServletUtility.getParameter("subjectName", request)%>">
						&emsp;<label>CourseName:</label> <%=HTMLUtility.getList("coursename", String.valueOf(bean.getCourseId()), clist)%>
