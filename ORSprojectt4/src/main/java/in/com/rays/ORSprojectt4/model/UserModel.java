...
public class UserModel {
	...
	public Integer nextPK() throws DatabaseException {
		System.out.println("user model next pk");
	...
	public long add(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		System.out.println("user model add ");
		Connection conn = null;
		int pk = 0;
	...
	public void delete(UserBean bean) throws ApplicationException {
		System.out.println("user model delete ");
	...
	public UserBean findByPK(long pk) throws ApplicationException {
		System.out.println("user model  find by pk");
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException {
		System.out.println("user model update");
	...
	public List search(UserBean bean) throws ApplicationException {
		System.out.println("user model  pagination search");
	...
	public List search(UserBean bean, int pageNo, int pageSize) throws ApplicationException {
		System.out.println("user model  list search");
		...
		System.out.println("user model  pagination");
		if (pageSize > 0) {
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		System.out.println("user model list list");
	...
	public UserBean authenticate(String login, String password) throws ApplicationException {
		System.out.println("user model authenticate");
	...
	public List getRoles(UserBean bean) throws ApplicationException {
		System.out.println("user model list get roles ");
	...
	public boolean changePassword(Long id, String oldPassword, String newPassword)
		...
		System.out.println("user model change password");
	...
	public long registerUser(UserBean bean) throws ApplicationException, DuplicateRecordException {
		System.out.println("user model register user");
		// log.debug("Model add Started");
	...
	public boolean resetPassword(UserBean bean) throws ApplicationException {
		System.out.println("user model reset password");
	...
	public boolean forgetPassword(String login) throws ApplicationException, RecordNotFoundException {
		System.out.println("user model forgot password");
