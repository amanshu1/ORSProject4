...
public class CollegeModel {
    ...
    public Integer nextPK() throws DatabaseException {
    	System.out.println("college model next pk");
    ...
    public long add(CollegeBean bean) throws ApplicationException,DuplicateRecordException {
    	...
    	System.out.println("college model add ");
        Connection conn = null;
        int pk = 0;
    ...
    public void delete(CollegeBean bean) throws ApplicationException {
    	System.out.println("college model delete ");
    ...
    public CollegeBean findByName(String name) throws ApplicationException {
    	System.out.println("college model  find by name");
    ...
    public CollegeBean findByPK(long pk) throws ApplicationException {
    	System.out.println("college model  find by pk");
    ...
    public void update(CollegeBean bean) throws ApplicationException,
    	...
    	System.out.println("college model update ");
    ...
    public List search(CollegeBean bean, int pageNo, int pageSize)
    	...
    	System.out.println("college model list search ");
    ...
    public List list(int pageNo, int pageSize) throws ApplicationException {
    	System.out.println("college model  list list");
