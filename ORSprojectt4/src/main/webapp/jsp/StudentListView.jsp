...
<!DOCTYPE html>
<%@page import="in.com.rays.ORSprojectt4.model.StudentModel"%>
<%@page import="in.com.rays.ORSprojectt4.utility.HTMLUtility"%>
<%@page import="in.com.rays.ORSprojectt4.servlet.StudentListCtl"%>
<%@page import="in.com.rays.ORSprojectt4.utility.ServletUtility"%>
<%@page import="in.com.rays.ORSprojectt4.bean.StudentBean"%>
		...
		<form action="<%=ORSView.STUDENT_LIST_CTL%>" method="post">
			...
			<h2>
				...
				<h2>
					...
					<table width="100%">
						<tr>
							<td align="center"><label> Name :</label> <%=HTMLUtility.getList("name", String.valueOf(bean.getId()), stlist)%>

								<label>Email_Id:</label> <input type="text" name="email"
								placeholder="Enter a Login_id"
