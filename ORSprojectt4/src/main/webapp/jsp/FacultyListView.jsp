...
<%@page import="in.com.rays.ORSprojectt4.model.FacultyModel"%>
<%@page import="in.com.rays.ORSprojectt4.bean.FacultyBean"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="in.com.rays.ORSprojectt4.servlet.FacultyListCtl"%>
...
<body>
	...
	<jsp:useBean id="bean"
		class="in.com.rays.ORSprojectt4.bean.FacultyBean" scope="request"></jsp:useBean>
	<center>
		<form action="<%=ORSView.FACULTY_LIST_CTL%>" method="post">
			...
			<table width="100%" align="center">
				<tr>
					<th></th>
					<td align="center"><label>First Name :</label> <%-- 	<input type="text" name="firstname" placeholder="Enter First Name" value=<%=ServletUtility.getParameter("firstname", request) %>> --%>
