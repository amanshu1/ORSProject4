...
<!DOCTYPE html>
<%@page import="in.com.rays.ORSprojectt4.servlet.TimeTableCtl"%>
<%@page import="java.util.LinkedHashMap"%>
<%@page import="java.util.Iterator"%>
<%@page import="in.com.rays.ORSprojectt4.utility.HTMLUtility"%>
<%@page import="in.com.rays.ORSprojectt4.bean.TimeTableBean"%>
<%@page import="java.util.List"%>
<%@page import="in.com.rays.ORSprojectt4.model.TimeTableModel"%>
<%@page import="in.com.rays.ORSprojectt4.servlet.TimeTableListCtl"%>
...
<body>
	<jsp:useBean id="bean" class="in.com.rays.ORSprojectt4.bean.TimeTableBean" scope="request"></jsp:useBean>
